...
static void amiibo_scene_amiibo_detail_menu_on_selected(mui_list_view_event_t event, mui_list_view_t *p_list_view,
    ...
    case AMIIBO_DETAIL_MENU_AUTO_RAND_UID: {
        ...
        sprintf(txt, "自動隨機生成 [%s]", p_settings->auto_gen_amiibo ? "開" : "關");
        settings_save();
...
void amiibo_scene_amiibo_detail_menu_on_enter(void *user_data) {
    ...
    mui_list_view_add_item(app->p_list_view, 0xe1c5, "隨機生成", (void *)AMIIBO_DETAIL_MENU_RAND_UID);
    ...
    mui_list_view_add_item(app->p_list_view, 0xe1c7, "刪除標簽", (void *)AMIIBO_DETAIL_MENU_REMOVE_AMIIBO);
    mui_list_view_add_item(app->p_list_view, 0xe068, "返回詳情", (void *)AMIIBO_DETAIL_MENU_BACK_AMIIBO_DETAIL);
    mui_list_view_add_item(app->p_list_view, 0xe069, "返回文件列表", (void *)AMIIBO_DETAIL_MENU_BACK_FILE_BROWSER);
    mui_list_view_add_item(app->p_list_view, 0xe1c8, "返回主菜單", (void *)AMIIBO_DETAIL_MENU_BACK_MAIN_MENU);
